    ...
    <div tw="flex flex-col items-center min-h-screen py-0 px-2">
      ...
      <main tw="flex flex-1 flex-col items-center justify-center py-20 px-0">
        <h1 tw="text-6xl text-center m-0">
          Welcome to{' '}
          <a tw="text-blue-400 no-underline hover:underline" href="https://nextjs.org">
            Next.js!
          </a>
        </h1>

        <h2 tw="text-2xl text-center m-0">Congrats on successfully setting up twin.macro with emotionjs! yay</h2>
